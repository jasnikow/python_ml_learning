...
class AdalineGD(object):
    ...
    Współczynnik uczenia (w zakresie pomiędzy 0.0 i 1.0). n_iter : liczba całkowita
    Liczba przebiegów po zestawie uczącym. random_state : liczba całkowita
    Ziarno generatora liczb losowych służące do inicjowania
    losowych wag. 
    Atrybuty
    -----------
    w_ : jednowymiarowa tablica
    Wagi po dopasowaniu. cost_ : lista
